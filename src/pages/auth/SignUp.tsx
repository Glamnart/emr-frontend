      ...
      <div className="flex w-full flex-col justify-center px-10 md:w-1/2">
        ...
        <div className="flex gap-4  justify-center mt-2">
          ...
          >
            ...
            <span className="text-[11px] font-bold text-[#1e293b]">Apple</span>
          </button>
          <button
            type="button"
            className="flex items-center justify-center w-[140px] px-4 py-2.5 bg-white rounded-md shadow-sm hover:bg-gray-50 transition-colors text-[11px]"
          >
            ...
            <span className="text-[11px] font-bold text-[#1e293b]">Google</span>
          </button>
        </div>
        ...
        <form onSubmit={(e) => e.preventDefault()} className="mt-6 space-y-4">
          ...
          <div className="mt-6 flex justify-between">
            ...
            <Button type="button" onClick={handleNext} className="ml-auto bg-[#0EA5E9] px-[80px] py-[20px] rounded-sm hover:bg-[#0676A8] text-[16px] font-bold">
