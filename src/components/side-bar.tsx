...
const NavBar : React.FC<SideBarProp> = ({page})=>{
  ...
  return<div className=" h-full overflow-y-auto flex flex-col gap-1.5 font-light text-[13px] pl-4 w-53 border-r border-b-gray-800 scrollbar-thin scrollbar-thumb-card pr dark:bg-gray-800">
    <div className="flex flex-row items-center gap-1.5 pt-5 pb-1 ">
        ...
        <p className="font-bold text-sm dark:text-white">SERENE EMR</p>
    </div> 
    ...
    <div>
      <button onClick={()=> setSettingsDown(!settingsDown)} className="flex -mt-1.5 rounded-lg h-9 pl-2 w-45 text-gray-400 font-medium flex-row items-center gap-1.5 cursor-pointer dark:hover:bg-gray-800 hover:bg-gray-100 dark:hover:text-white">
      ...
      <div className={`${ settingsDown ? "flex flex-col pl-7 text-[12px] text-gray-500 dark:text-white" : "hidden"}`}>
    ...
    <div>
      <button onClick={()=> setHelpDown(!helpDown)} className="flex -mt-2 rounded-lg h-9 pl-2 w-45 text-gray-400 font-medium flex-row items-center gap-1.5 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white">
      ...
      <div className={`${ helpDown ? "flex flex-col pl-7 text-[12px] text-gray-500 dark:text-white" : "hidden"}`}>
    ...
    <div className="flex border-t -ml-5 items-center mt-2">
      <div className="flex flex-row border rounded-lg items-center justify-center w-45 p-1.5 text-gray-400 mt-5 mb-5 ml-4">
        ...
        <div className="flex-1 flex flex-col ml-2 font-xs">
          <div className="font-bold -mb-1.5 text-gray-800 dark:text-white">Dr. Sarah Chen</div>
          <div>Super Admin</div>
        </div>
